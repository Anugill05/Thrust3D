  ...
  return (
    <div>
      <PageHeader
        ...
        title="About Us"
        subtitle="Where innovation meets precision manufacturing."
      />
      ...
      <div className="page-container py-12">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <h2 className="section-heading mb-4">
              Welcome to Thrust 3D
            </h2>

            <p className="text-slate-500 leading-relaxed mb-4">
              Welcome to Thrust 3D, where innovation meets precision manufacturing.
              Based in Phagwara, Punjab, we specialize in high-quality 3D printing,
              rapid prototyping, and custom manufacturing solutions designed to
              transform ideas into reality.
            </p>

            <p className="text-slate-500 leading-relaxed mb-6">
              At Thrust 3D, we believe that every great product begins with a powerful idea.
              Our mission is to help students, startups, engineers, creators, and businesses
              bring those ideas to life through advanced additive manufacturing technology
          ...
          <div className="aspect-video bg-slate-100 rounded-2xl overflow-hidden">
            <img
              src="https://placehold.co/640x360/e2e8f0/475569?text=Thrust+3D+Facility"
              alt="Facility"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {[
            ...
            { icon: CheckCircle, value: '4.9/5', label: 'Customer Rating' }
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-3 text-slate-600">
            {[
              ...
              'Quality Assurance',
              'Support for Students, Startups & Businesses',
              'Quick Response & Technical Guidance'
            ].map(item => (
        ...
        {/* VISION */}
        <div className="card p-8 bg-primary-50 border-primary-100 text-center mb-16">
          <h3 className="section-heading mb-3">Our Vision</h3>
          <p className="text-slate-600">
            To become a leading innovation-driven 3D printing and prototyping company in India
            by empowering creators, engineers, and businesses with accessible and reliable
        ...
        <div className="card p-8 text-center">
          <h3 className="section-heading mb-3">Our Location</h3>
